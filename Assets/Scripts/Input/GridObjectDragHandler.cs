...
public class GridObjectDragHandler : MonoBehaviour
{
    ...
    private void Awake()
    {
        Debug.Log("[GridObjectDragHandler] Awake called");
        if (mainCamera == null)
    ...
    {
        Debug.Log("[GridObjectDragHandler] Click performed");
    ...
    private void BeginDrag(BridgeSegment segment)
    {
        ...
        Debug.Log($"[GridObjectDragHandler] Started dragging {segment.Type} segment");
    }
    ...
    private void EndDrag()
    {
        ...
        Debug.Log($"[GridObjectDragHandler] Ended drag - Success: {success}");
